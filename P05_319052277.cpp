...
int main()
{
	...
	LlantaTrasDer = Model();
	LlantaTrasDer.LoadModel("Models/LlantaTrasDer.obj");

	LlantaTrasIzq = Model();
	LlantaTrasIzq.LoadModel("Models/LlantaTrasIzq.obj");
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, -19.0f, mainWindow.getMovGral()));
		modelaux = model;
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		Auto.RenderModel();
		...
		// COFRE
		color = glm::vec3(0.65f, 0.25f, 0.50f); // rosa 
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.0f, 48.9f, 21.0f));
		...
		//LLANTAS
		float rotLlanta = mainWindow.getarticulacion2();
		// LLANTA delantera derecha
		color = glm::vec3(1.0f, 1.0f, 0.0f); // amarillo
		model = modelaux;
		model = glm::translate(model, glm::vec3(24.0f, 30.0f, 40.0f));
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(24.0f, 30.0f, -35.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion2()), glm::vec3(1, 0, 0));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		LlantaTrasDer.RenderModel();
