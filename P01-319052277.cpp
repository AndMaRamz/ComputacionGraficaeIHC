...
int main()
{
 ...
 //Llamada a las funciones creadas antes del main
	...
	while (!glfwWindowShouldClose(mainWindow))
	{
		...
		int colorActual = orden[indice];

		glClearColor(
			colores[colorActual][0],
			colores[colorActual][1],
			colores[colorActual][2],
			colores[colorActual][3]
		);
