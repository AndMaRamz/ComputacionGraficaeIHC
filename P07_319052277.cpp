...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		// Luz faro auto
		glm::vec3 posicionAuto = glm::vec3(model[3]);
		glm::vec3 frenteAuto = glm::normalize(glm::vec3(model * glm::vec4(0, 0, 1, 0)));
		glm::vec3 posicionFaro = posicionAuto + frenteAuto * 2.5f + glm::vec3(0.0f, 0.2f, 0.0f);
